...
export class BooksApiEffects {
  constructor(private booksService: BooksService, private actions$: Actions ) {} // actions$ is passing in an observable of all actions

  loadBooks$ = createEffect(() =>
    this.actions$.pipe(
      ofType(BooksPageActions.enter),  // filters all actions down to the one you are interested in 
      exhaustMap(() =>
        this.booksService
          .all()
